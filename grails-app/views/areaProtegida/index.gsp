...
<html>
  ...
  <body>
    ...
    <ul class="nav nav-tabs">
      ...
      <li class="nav-item">
        <a class="nav-link text-success" href="/admin/area/nueva">
          <i class="fas fa-plus"></i><strong> Nueva área protegida</strong></a>
      </li>
    </ul>
          ...
          <tr class="item${areaProtegida.id} text-dark">
            ...
            <td>
              <div class="text-center">
                <a href="/admin/area/mostrar/${areaProtegida.id}" class="btn btn-success btn-sm" role="button"><i class="far fa-eye"></i></a>
                <a href="/admin/area/editar/${areaProtegida.id}" class="btn btn-warning btn-sm" role="button"><i class="far fa-edit"></i></a>
