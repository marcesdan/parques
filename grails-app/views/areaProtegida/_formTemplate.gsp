...
<div class="form-row">
  <div class="form-group col-md-4">
    ...
    <select class="custom-select" value="${areaProtegida.delegacion}">
...
<div class="form-row">
  <div class="form-group col-sm-6">
      ...
      <input type="text" class="form-control" name="logo" value="${areaProtegida.logo?.url}">
  </div>
  <div class="form-group col-sm-6">
    <label for="imagen_principal">Imagen principal</label>
    <input type="text" class="form-control" name="imagen_principal" value="${areaProtegida.imagen_principal?.url}">
  </div>
</div>
